...
public OnPluginStart()
{
	...
	hSpawnLimits[SI_BOOMER] = CreateConVar("l4d2_ais_boomer_limit", "1", "The max amount of boomers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_HUNTER] = CreateConVar("l4d2_ais_hunter_limit", "1", "The max amount of hunters present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_SMOKER] = CreateConVar("l4d2_ais_smoker_limit", "1", "The max amount of smokers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_TANK] = CreateConVar("l4d2_ais_tank_limit", "0", "The max amount of tanks present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_CHARGER] = CreateConVar("l4d2_ais_charger_limit", "1", "The max amount of chargers present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_JOCKEY] = CreateConVar("l4d2_ais_jockey_limit", "1", "The max amount of jockeys present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hSpawnLimits[SI_SPITTER] = CreateConVar("l4d2_ais_spitter_limit", "1", "The max amount of spitters present at once", FCVAR_PLUGIN, true, 0.0, true, 14.0);
	hScaleWeights = CreateConVar("l4d2_ais_scale_weights", "0", "[0=OFF|1=ON] Scale spawn weights with the limits of corresponding SI", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	hWitchPeriod = CreateConVar("l4d2_ais_witch_period", "300.0", "The time (seconds) interval in which exactly one witch will spawn", FCVAR_PLUGIN, true, 1.0);
	...
	hSILimit = CreateConVar("l4d2_ais_limit", "3", "The max amount of special infected at once", FCVAR_PLUGIN, true, 1.0, true, float(MAX_INFECTED));
	hSILimitMax = FindConVar("z_max_player_zombies");
	hSpawnSize = CreateConVar("l4d2_ais_spawn_size", "1", "The amount of special infected spawned at each spawn interval", FCVAR_PLUGIN, true, 1.0, true, float(MAX_INFECTED));
	...
	hSpawnTimeMin = CreateConVar("l4d2_ais_time_min", "0.0", "The minimum auto spawn time (seconds) for infected", FCVAR_PLUGIN, true, 0.0);
	hSpawnTimeMax = CreateConVar("l4d2_ais_time_max", "60.0", "The maximum auto spawn time (seconds) for infected", FCVAR_PLUGIN, true, 1.0);
